...
class _SubscriptionPlansScreenState extends State<SubscriptionPlansScreen> {
  ...
  void _handlePlanSelection(
    ...
    // Assume isYearly is true for the prices shown in image (often annual)
    // or just pass false. The image says "Applicable for 12 and 24 months only", implying yearly commitment.
    Navigator.push(
      context,
      MaterialPageRoute(
