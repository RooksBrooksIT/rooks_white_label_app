...
@interface STPAddressViewController (SWIFT_EXTENSION(StripePaymentSheet)) <UIAdaptivePresentationControllerDelegate>
...
SWIFT_CLASS("_TtC18StripePaymentSheet15ExperimentsData")
@interface ExperimentsData : NSObject <STPAPIResponseDecodable>
