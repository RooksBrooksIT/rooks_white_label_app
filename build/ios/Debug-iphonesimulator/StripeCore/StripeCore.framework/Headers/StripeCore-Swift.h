...
+ (NSError * _Nonnull)stp_cardBrandNotUpdatedError SWIFT_WARN_UNUSED_RESULT;
+ (NSError * _Nonnull)stp_defaultPaymentMethodNotUpdatedError SWIFT_WARN_UNUSED_RESULT;
+ (NSError * _Nonnull)stp_genericErrorOccurredError SWIFT_WARN_UNUSED_RESULT;
...
+ (NSString * _Nonnull)stp_cardBrandNotUpdatedMessage SWIFT_WARN_UNUSED_RESULT;
+ (NSString * _Nonnull)stp_defaultPaymentMethodNotUpdatedMessage SWIFT_WARN_UNUSED_RESULT;
+ (NSString * _Nonnull)stp_genericErrorOccurredMessage SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC10StripeCore28STPClientAttributionMetadata")
@interface STPClientAttributionMetadata : NSObject
@property (nonatomic, copy) NSDictionary * _Nonnull additionalAPIParameters;
/// The identifier string for the session
@property (nonatomic, readonly, copy) NSString * _Nullable clientSessionId;
/// The identifier string for the elements session
@property (nonatomic, copy) NSString * _Nullable elementsSessionConfigId;
/// The source for the merchant integration
@property (nonatomic, readonly, copy) NSString * _Nonnull merchantIntegrationSource;
/// The subtype for the merchant integration
@property (nonatomic, readonly, copy) NSString * _Nonnull merchantIntegrationSubtype;
/// The version for the merchant integration
@property (nonatomic, readonly, copy) NSString * _Nonnull merchantIntegrationVersion;
/// The intent creation flow for the merchant integration. Can be <code>standard</code> or <code>deferred</code>
@property (nonatomic, copy) NSString * _Nullable paymentIntentCreationFlow;
/// The payment method selection for the merchant integration. Can be <code>automatic</code> or <code>merchant_specified</code>
@property (nonatomic, copy) NSString * _Nullable paymentMethodSelectionFlow;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// \param errorCode The error code string from Stripe API (e.g., “incorrect_number”, “card_declined”)
///
/// \param declineCode The decline code string from Stripe API (e.g., “insufficient_funds”, “card_velocity_exceeded”)
///
///
/// returns:
/// A localized error message, or nil if the error code is not recognized
+ (NSString * _Nullable)localizedUserMessageForErrorCode:(NSString * _Nonnull)errorCode declineCode:(NSString * _Nullable)declineCode SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
