...
/// if you requested authentication while displaying an STPBankSelectionViewController, you may want to hide
/// it to return the user to your desired view controller.
- (void)authenticationContextDidDismissViewController:(UIViewController * _Nonnull)viewController;
@end
...
@interface STPClientAttributionMetadata (SWIFT_EXTENSION(StripePayments)) <STPFormEncodable>
+ (NSString * _Nullable)rootObjectName SWIFT_WARN_UNUSED_RESULT;
+ (NSDictionary<NSString *, NSString *> * _Nonnull)propertyNamesToFormFieldNamesMapping SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC14StripePayments21STPConfirmLinkOptions")
@interface STPConfirmLinkOptions : NSObject
...
@interface STPConfirmLinkOptions (SWIFT_EXTENSION(StripePayments)) <STPFormEncodable>
+ (NSString * _Nullable)rootObjectName SWIFT_WARN_UNUSED_RESULT;
+ (NSDictionary<NSString *, NSString *> * _Nonnull)propertyNamesToFormFieldNamesMapping SWIFT_WARN_UNUSED_RESULT;
@end
...
@property (nonatomic, strong) STPConfirmLinkOptions * _Nullable linkOptions;
...
/// seealso:
/// https://stripe.com/docs/api/confirmation_tokens
SWIFT_CLASS("_TtC14StripePayments20STPConfirmationToken")
@interface STPConfirmationToken : NSObject <STPAPIResponseDecodable>
/// :nodoc:
@property (nonatomic, readonly, copy) NSDictionary * _Nonnull allResponseFields;
+ (nullable instancetype)decodedObjectFromAPIResponse:(NSDictionary * _Nullable)response SWIFT_WARN_UNUSED_RESULT;
/// :nodoc:
...
/// seealso:
/// https://stripe.com/docs/api/confirmation_tokens
SWIFT_CLASS("_TtC14StripePayments26STPConfirmationTokenParams")
@interface STPConfirmationTokenParams : NSObject <STPFormEncodable>
...
@property (nonatomic, strong) STPPaymentMethodParams * _Nullable paymentMethodData;
/// Payment-method-specific configuration for this ConfirmationToken.
@property (nonatomic, strong) STPPaymentMethodOptions * _Nullable paymentMethodOptions;
...
/// <code>@YES</code> to set this ConfirmationToken’s PaymentMethod as the associated Customer’s default
...
/// Automatic payment methods configuration for <code>STPPaymentIntent</code> and <code>STPSetupIntent</code>.
SWIFT_CLASS("_TtC14StripePayments32STPIntentAutomaticPaymentMethods")
@interface STPIntentAutomaticPaymentMethods : NSObject
@property (nonatomic, readonly, copy) NSDictionary * _Nonnull allResponseFields;
/// :nodoc:
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
...
@interface STPIntentAutomaticPaymentMethods (SWIFT_EXTENSION(StripePayments)) <STPAPIResponseDecodable>
+ (nullable instancetype)decodedObjectFromAPIResponse:(NSDictionary * _Nullable)response SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface STPMandateCustomerAcceptanceParams (SWIFT_EXTENSION(StripePayments)) <STPAPIResponseDecodable>
+ (nullable instancetype)decodedObjectFromAPIResponse:(NSDictionary * _Nullable)response SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface STPMandateDataParams (SWIFT_EXTENSION(StripePayments)) <STPAPIResponseDecodable>
+ (nullable instancetype)decodedObjectFromAPIResponse:(NSDictionary * _Nullable)response SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface STPMandateOnlineParams (SWIFT_EXTENSION(StripePayments)) <STPAPIResponseDecodable>
+ (nullable instancetype)decodedObjectFromAPIResponse:(NSDictionary * _Nullable)response SWIFT_WARN_UNUSED_RESULT;
@end
...
@property (nonatomic, strong) STPRadarOptions * _Nullable radarOptions;
/// Shipping information.
@property (nonatomic, strong) STPPaymentIntentShippingDetailsParams * _Nullable shipping;
/// Contains metadata with identifiers for the session and information about the integration
@property (nonatomic, strong) STPClientAttributionMetadata * _Nullable clientAttributionMetadata;
/// The URL to redirect your customer back to after they authenticate or cancel
/// their payment on the payment method’s app or site.
...
/// If this is a ShopPay PaymentMethod (i.e. <code>self.type == STPPaymentMethodTypeShopPay</code>), this contains additional details.
@property (nonatomic, readonly, strong) STPPaymentMethodShopPay * _Nullable shopPay;
...
@class STPPaymentMethodShopPayParams;
...
@property (nonatomic, strong) STPPaymentMethodShopPayParams * _Nullable shopPay;
/// Radar options that may contain HCaptcha token
@property (nonatomic, strong) STPRadarOptions * _Nullable radarOptions;
...
/// \param shopPay An object containing additional ShopPay details.
///
/// \param billingDetails An object containing the user’s billing details.
///
/// \param metadata Additional information to attach to the PaymentMethod.
///
- (nonnull instancetype)initWithShopPay:(STPPaymentMethodShopPayParams * _Nonnull)shopPay billingDetails:(STPPaymentMethodBillingDetails * _Nullable)billingDetails metadata:(NSDictionary<NSString *, NSString *> * _Nullable)metadata;
...
SWIFT_CLASS("_TtC14StripePayments23STPPaymentMethodPreview")
@interface STPPaymentMethodPreview : NSObject <STPAPIResponseDecodable>
/// You cannot directly instantiate an <code>STPPaymentMethodPreview</code>. You should only use one that is returned from the Stripe API.
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
/// :nodoc:
@property (nonatomic, readonly, copy) NSDictionary * _Nonnull allResponseFields;
...
SWIFT_CLASS("_TtC14StripePayments23STPPaymentMethodShopPay")
@interface STPPaymentMethodShopPay : NSObject <STPAPIResponseDecodable>
@property (nonatomic, readonly, copy) NSDictionary * _Nonnull allResponseFields;
/// Associated external source Id
@property (nonatomic, readonly, copy) NSString * _Nonnull externalSourceId;
/// :nodoc:
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
+ (nullable instancetype)decodedObjectFromAPIResponse:(NSDictionary * _Nullable)response SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC14StripePayments29STPPaymentMethodShopPayParams")
@interface STPPaymentMethodShopPayParams : NSObject <STPFormEncodable>
@property (nonatomic, copy) NSDictionary * _Nonnull additionalAPIParameters;
/// Corresponding externalSourceId. Required.
@property (nonatomic, copy) NSString * _Nullable externalSourceId;
+ (NSString * _Nullable)rootObjectName SWIFT_WARN_UNUSED_RESULT;
+ (NSDictionary<NSString *, NSString *> * _Nonnull)propertyNamesToFormFieldNamesMapping SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// A ShopPay payment method
  STPPaymentMethodTypeShopPay = 42,
/// An unknown type.
  STPPaymentMethodTypeUnknown = 43,
};
...
SWIFT_CLASS("_TtC14StripePayments15STPRadarOptions")
@interface STPRadarOptions : NSObject
@property (nonatomic, copy) NSDictionary * _Nonnull additionalAPIParameters;
@property (nonatomic, copy) NSString * _Nullable hcaptchaToken;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

@interface STPRadarOptions (SWIFT_EXTENSION(StripePayments)) <STPFormEncodable>
+ (NSString * _Nullable)rootObjectName SWIFT_WARN_UNUSED_RESULT;
+ (NSDictionary<NSString *, NSString *> * _Nonnull)propertyNamesToFormFieldNamesMapping SWIFT_WARN_UNUSED_RESULT;
@end
